...
class ConvertToUppercaseAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_convert_uppercase)
...
class ConvertToLowercaseAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_convert_lowercase)
...
class DeleteLineAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_delete_line)
...
class DuplicateLineAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_duplicate_line)
...
class CopyLineAction(private val context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_copy_line)
  ...
  override suspend fun execAction(data: ActionData): Boolean {
    ...
    Toast.makeText(context, R.string.editor_toast_copied_to_clipboard, Toast.LENGTH_SHORT).show()
    return true
  }
}
...
class CommentLineAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_comment_line)
...
class MoveLineUpAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_move_line_up)
...
class MoveLineDownAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_move_line_down)
...
class InsertLineAboveAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_insert_line_above)
...
class InsertLineBelowAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_insert_line_below)
...
class SelectLineAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_select_line)
...
class TrimTrailingWhitespaceAction(private val context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_trim_trailing_whitespace)
  ...
  override suspend fun execAction(data: ActionData): Boolean {
    ...
    Toast.makeText(
        context,
        R.string.editor_toast_trailing_whitespace_removed,
        Toast.LENGTH_SHORT,
    ).show()
    return true
  }
...
class IndentLineAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_indent_line)
...
class UnindentLineAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_unindent_line)
...
class JoinLinesAction(context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_join_lines)
...
class ClearAllAction(private val context: Context, override val order: Int) : EditorActivityAction() {
  ...
  init {
    label = context.getString(R.string.editor_action_clear_all)
  ...
  override suspend fun execAction(data: ActionData): Boolean {
    ...
    MaterialAlertDialogBuilder(activity)
      .setTitle(R.string.editor_clear_all_title)
      .setMessage(R.string.editor_clear_all_message)
      .setPositiveButton(R.string.editor_clear_all_confirm) { _, _ ->
        TextTransformers(editor).clearAll()
        Toast.makeText(context, R.string.editor_toast_cleared, Toast.LENGTH_SHORT).show()
      }
